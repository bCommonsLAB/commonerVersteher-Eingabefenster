    ...
    sendBtn.addEventListener('click', () => {
        ...
        .then(data => {
            ...
            if (data.error) {
                ...
                const reflectionElement = document.getElementById('reflection');
                if (transcriptionElement) transcriptionElement.innerText = data.Transcript || '';
                if (reflectionElement) reflectionElement.innerText = data.Eindruck || '';
                ...
                updateCircle('circle-kommerziell', 'kommerziell-prozent', data.Kommerziell);
